...
import org.example.wchat.databinding.ActivitySettingsBinding;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!binding.etStatus.getText().equals("") && !binding.txtUsername.getText().toString().equals(""))
                {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        // it means user has selected some image:
        if(data.getData()!=null)
        {
            ...
            // storing image path in real time databse.
